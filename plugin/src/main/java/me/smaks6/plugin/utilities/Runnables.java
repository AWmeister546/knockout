...
public class Runnables {
    ...
    public static void revivePlayer(Player player, Player reviver){
        ...
        new BukkitRunnable() {
            ...
            int time = 0;
            final int requiredLevel = Main.getInstance().getConfig().getInt("levelRequired");
            ...
            public void run() {
                ...
                player.sendTitle(ChatColor.translateAlternateColorCodes('&', Main.getInstance().getConfig().getString("messages.wakeUpTitle")),ChatColor.GREEN + "" + time + "%", 1 , 20 , 1 );
                reviver.sendTitle(ChatColor.translateAlternateColorCodes('&', Main.getInstance().getConfig().getString("messages.wakeUpTitle")),ChatColor.GREEN + "" + time + "%", 1 , 20 , 1 );
...
//                    reviver.sendMessage(ChatColor.DARK_GREEN + Main.getInstance().getConfig().getString("wakeupplayer").replace("{player}", player.getName()));
                    reviver.sendTitle(ChatColor.translateAlternateColorCodes('&', Main.getInstance().getConfig().getString("messages.aliveTitle")), ChatColor.translateAlternateColorCodes('&', Main.getInstance().getConfig().getString("messages.aliveSubtitle").replace("%player%", player.getDisplayName())));
                    Pose.stop(reviver);
    ...
    public static void revivePlayerCmd(Player player, Player reviver){
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if(!PlayerUtilities.isNull(player)) {
                    ...
                    player.sendTitle(ChatColor.translateAlternateColorCodes('&', Main.getInstance().getConfig().getString("messages.knockoutTitle")), ChatColor.WHITE + timeToDisplay, 1, 20, 1);
